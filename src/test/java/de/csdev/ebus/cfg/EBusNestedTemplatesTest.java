...
public class EBusNestedTemplatesTest {
    ...
    public void before() throws IOException, EBusConfigurationReaderException {
        ...
        commandRegistry.loadCommandCollection(EBusNestedTemplatesTest.class.getResource("/nested-templates/FirstTemplate.json"));
        commandRegistry.loadCommandCollection(EBusNestedTemplatesTest.class.getResource("/nested-templates/SecondTemplate.json"));
        commandRegistry.loadCommandCollection(EBusNestedTemplatesTest.class.getResource("/nested-templates/ThirdCommand.json"));
    }

    @Test
    public void testIdentification() {

        IEBusCommandMethod commandMethod = commandRegistry.getCommandMethodById("et",
                "test.nextest-block", IEBusCommandMethod.Method.SET);
    ...
    public void testX() throws EBusTypeException {
        ...
        IEBusCommandMethod commandMethod = commandRegistry.getCommandMethodById("et",
                "test.tth", IEBusCommandMethod.Method.SET);
    ...
    public void testY() throws EBusTypeException {
        ...
        IEBusCommandMethod commandMethod = commandRegistry.getCommandMethodById("et",
                "test.to", IEBusCommandMethod.Method.SET);
