 ...
 */
package de.csdev.ebus.cfg.json.v1.mapper;
...
public class EBusConfigurationTelegram {
    ...
    public void setComputedValues(Map<String, EBusConfigurationValue> computedValues) {
     ...
     * @param values
     */
    public void setValues(Map<String, EBusConfigurationValue> values) {
        this.values = values;
    }
    ...
    public boolean equals(Object obj) {
        ...
        EBusConfigurationTelegram other = (EBusConfigurationTelegram) obj;
        if (clazz == null) {
            if (other.clazz != null) {
                return false;
            }
