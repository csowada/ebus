...
public class EBusComposeTelegramTest2 {
    ...
    public void composeTelegram01() throws EBusTypeException {
        IEBusCommandMethod command = configurationProvider.getConfigurationById("fbh.set_heizkurve", IEBusCommandMethod.Method.GET);
        ...
        parserService.addEBusParserListener(new EBusParserListener() {
            ...
            public void onTelegramResolved(IEBusCommandMethod command, Map<String, Object> result, byte[] receivedData,
                    Integer sendQueueId) {
                System.out.println(
