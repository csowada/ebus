...
//            File filex = new File("src/main/resources/common-configuration.json");
            ...
            EBusCommand command = client.getConfigurationProvider().getConfigurationById("common.error");
            ...
            ByteBuffer composeEBusTelegram2 = EBusCommandUtils.buildMasterTelegram(command, null, (byte) 0xFF, values);
